        ...
        $(".tabs a span").toArray().forEach(function (element) {
            ...
            $(element).on("click", function () {
                ...
                if ($element.parent().is(":nth-child(1)")) {
                    ...
                    var $input = $("<input placeholder='Задача'>").addClass("text")
                        , $tagInput = $("<input placeholder='Тэги'>").addClass("tags")
                        , $button = $("<button>").addClass("add").text("Добавить    ");
                    $button.on("click", function () {
                        var description = $input.val(), // разделение в соответствии с запятыми
                    ...
                    $("main .content").append($input).append("<br>").append($tagInput).append("<br>").append($button);
                }
                return false;
            })
        })
